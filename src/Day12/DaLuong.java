...
public class DaLuong extends javax.swing.JFrame implements Runnable {
    ...
    public DaLuong() {
        initComponents();
        // tạo đa luồng trong jframe hiện tại
    ...
    private void initComponents() {
        ...
        lblChuongTrinh.setText("thời gian chạy chương trình");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(106, 106, 106)
                .addComponent(lblTieuDe, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void run() {
        ...
        while (true) {
            ...
            gio = ca.get(Calendar.HOUR); // giờ hiện tại 
            phut = ca.get(Calendar.MINUTE); // phút hiện tại
            giay = ca.get(Calendar.SECOND); // giây hiện tại
            // hiển thị giá trị trên lable
            lblChuongTrinh.setText(h + ":" + m + ":" +s);
            lblMayTinh.setText(gio + ":" + phut + ":" + giay);
            
            // Lấy ra ký tự đầu tiên trong tiêu đề
            String kyTu = lblTieuDe.getText().substring(0, 1);
            String sauXoa = lblTieuDe.getText().substring(1);
            lblTieuDe.setText(sauXoa + kyTu);
